...
```{r}
bikeshare = read_excel("202008-capitalbikeshare-tripdata_excel.xlsx") %>% clean_names()
```
...
This is a very large data set with a lot of columns. This gives us a wealth of information to look at. 
